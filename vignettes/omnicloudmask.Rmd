...
by any GDAL tool and re-read by garry about 9x faster than tiled
...
`mask_asset` intact. From here on, nothing touches the network.


``` r
garry_daemons()

ds <- materialise(remote, file.path(tempdir(), "zurich"),
                  name = "zurich")
ds
#> ── <LazyDataset> ───────────────────────────────────────────────────────────────
...
#> function (x) 
#> .ocm_infer(x, weights)
#> <bytecode: 0x575df53f27a8>
#> <environment: 0x575df53f22d8>
#> 
#> $kernel_id
