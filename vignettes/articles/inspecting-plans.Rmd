...
A single-raster chain: scale a band, smooth it, and reduce. The DAG
shows how the planner fuses the map and the focal into one stage, and
how a spatial reduction becomes a two-stage barrier (per-chunk partials,
then a combine).
