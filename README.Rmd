...
It also shows something you cannot see from the code: masking connects the
band chains through the shared QA reads, so the planner fuses the entire
composite -- NDVI included -- into a single kernel per chunk.
